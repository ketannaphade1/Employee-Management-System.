...
//	@CrossOrigin("http://localhost:4200")
	...
	/*
	 * @GetMapping("/login/{emailId}/{password}") public
	 * ResponseEntity<Optional<Employee>>
	 * getDataByEmailAndPassword(@PathVariable("emailId") String
	 * emailId, @PathVariable("password") String password) {
	 * 
	 * Optional<Employee>
	 * data=employeeService.getDataByEmailAndPassword(emailId,password);
	 * 
	 * return new ResponseEntity<Optional<Employee>>(data,HttpStatus.OK);
	 * 
	 * 
	 * }
	 */
