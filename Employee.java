...
public class Employee {
	...
	public String toString() {
		return "Employee [id=" + id + ", firstName=" + firstName + ", lastName=" + lastName + ", emailId=" + emailId
				+ ", password=" + password + ", middleName=" + middleName + ", pAddress=" + pAddress
				+ ", corresponsenceAddress=" + corresponsenceAddress + ", yearsOfExp=" + yearsOfExp + ", mobNumber="
				+ mobNumber + ", lastorg=" + lastorg + ", secondlastorg=" + secondlastorg + ", currentCtc=" + currentCtc
				+ ", emergencyContact=" + emergencyContact + ", currentRole=" + currentRole + ", keyskill1=" + keyskill1
				+ ", keyskill2=" + keyskill2 + ", keyskill3=" + keyskill3 + ", keyskill4=" + keyskill4 + ", salary="
				+ salary + ", isAdmin=" + isAdmin + "]";
	}


	public Employee(int id, String firstName, String lastName, String emailId, String password, String middleName,
			String pAddress, String corresponsenceAddress, String yearsOfExp, String mobNumber, String lastorg,
			String secondlastorg, String currentCtc, String emergencyContact, String currentRole, String keyskill1,
			String keyskill2, String keyskill3, String keyskill4, String salary, int isAdmin) {
		super();
		this.id = id;
		this.firstName = firstName;
		this.lastName = lastName;
